...
const fileContentBuffer = fs.readFileSync(process.argv[2]);
const fileContentLinesArray = fileContentBuffer.toString().split("\n");
console.log(fileContentLinesArray.length - 1);
